...
public class Chapter02_book : MonoBehaviour {
	...
	public class SphericalCoordinates
	{
		...
		public Vector3 toCartesian
		{
			get
			{
				...
				return new Vector3(radius * Mathf.Cos(elevation) * Mathf.Cos(azimuth), radius * Mathf.Sin(elevation), radius * Mathf.Cos(elevation) * Mathf.Sin(azimuth));
			}
		}
